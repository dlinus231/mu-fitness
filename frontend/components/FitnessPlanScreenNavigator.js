...
import EditWorkoutPlanScreen from "./screens/fitnessPlanTabScreens/workoutPlansScreenComponents/EditWorkoutPlanScreen.js";
...
export default function FooterNavigator() {
  return (
    ...
    >
      <Stack.Screen
        name="fitnessPlanPageMenu"
        component={FitnessPlansMenuScreen}
      />
      ...
      <Stack.Screen
        ...
        component={RecommendedExercisesScreen}
      />
